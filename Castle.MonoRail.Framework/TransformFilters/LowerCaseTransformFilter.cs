...
namespace Castle.MonoRail.Framework.TransformFilters
{
	...
	/// </summary>
	public class LowerCaseTransformFilter : TransformFilter
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="LowerCaseTransformFilter"/> class.
		/// </summary>
		/// <param name="baseStream">The stream to write to after filtering.</param>
		public LowerCaseTransformFilter(Stream baseStream) : base(baseStream)
		{
		}
