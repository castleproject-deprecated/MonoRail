...
namespace Castle.MonoRail.Framework.Helpers
{
	...
	public class UrlHelper : AbstractHelper
	{
		...
		{
			return "<button type=\"button\" onclick=\"javascript:window.location.href = '" + JavaScriptEscape(For(parameters)) + "'\">" + innerContent + "</button>";
		}
		...
		{
			return "<button type=\"button\" " + GetAttributes(buttonAttributes) + "onclick=\"javascript:window.location.href = '" + JavaScriptEscape(For(parameters)) + "'\">" + innerContent + "</button>";
		}
