...
namespace System.Data.OData.Query
{
    ...
    internal sealed class BuiltInFunctionSignature : FunctionSignature
    {
        ...
        /// </summary>
        private ResourceType returnType;
        ...
        internal BuiltInFunctionSignature(Func<Expression[], Expression> buildExpression, ResourceType returnType, params ResourceType[] argumentTypes)
            : base(argumentTypes)
        {
        ...
        /// The return type of the function.
        /// </summary>
        internal ResourceType ReturnType
        {
            get
            {
                DebugUtils.CheckNoExternalCallers();
        ...
        /// <returns>Newly created function signature.</returns>
        /// <remarks>Note that arguments are always treated as non-nullable for the CLR method search, even if the ones specified are nullable.</remarks>
        internal static BuiltInFunctionSignature CreateFromStaticMethodCall(Type targetType, string methodName, ResourceType returnType, params ResourceType[] argumentTypes)
        {
            DebugUtils.CheckNoExternalCallers();
            ...
            MethodInfo method = targetType.GetMethod(
                ...
                null,
                argumentTypes.Select(argumentType => TypeUtils.GetNonNullableType(argumentType.InstanceType)).ToArray(),
                null);
