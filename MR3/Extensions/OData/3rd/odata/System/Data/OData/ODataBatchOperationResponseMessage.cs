...
#if ODATALIB_ASYNC
#if INTERNAL_DROP
    internal sealed class ODataBatchOperationResponseMessage : IODataResponseMessageAsync
#else
    public sealed class ODataBatchOperationResponseMessage : IODataResponseMessageAsync
#endif
#else
#if INTERNAL_DROP
    internal sealed class ODataBatchOperationResponseMessage : IODataResponseMessage
#else
