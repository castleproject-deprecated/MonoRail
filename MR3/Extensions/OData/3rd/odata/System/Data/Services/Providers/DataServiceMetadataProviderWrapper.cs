...
namespace System.Data.Services.Providers
{
    ...
    /// </summary>
    public sealed class DataServiceMetadataProviderWrapper
    {
        /// <summary>
		...
		public ResourceType ValidateResourceType(ResourceType resourceType)
        {
            DebugUtils.CheckNoExternalCallers();
		...
		public ResourceSetWrapper ValidateResourceSet(ResourceSet resourceSet)
        {
            DebugUtils.CheckNoExternalCallers();
		...
		public ServiceOperationWrapper ValidateServiceOperation(ServiceOperation serviceOperation)
        {
            DebugUtils.CheckNoExternalCallers();
		...
		public static void ValidateResourceTypeReadOnly(ResourceType resourceType)
        {
            Debug.Assert(resourceType != null, "resourceType != null");
		...
		public static void ValidateResourceSetReadOnly(ResourceSet resourceSet)
        {
            Debug.Assert(resourceSet != null, "resourceSet != null");
		...
		public static void ValidateServiceOperationReadOnly(ServiceOperation serviceOperation)
        {
		...
		public static void AddUniqueNameToSet(string name, HashSet<string> names, string exceptionString)
        {
            if (name != null)
            {
...
//				throw new ArgumentException("CanReflectOnInstanceTypeProperty = false");
				// return this.queryProvider.GetPropertyValue(target, resourceProperty);
//			try
//			{
//				if (resourceType == null)
//					resourceType = this.GetResourceType(target);
//				return resourceType.GetPropertyInfo(resourceProperty).GetGetMethod().Invoke(target, (object[])null);
//			}
