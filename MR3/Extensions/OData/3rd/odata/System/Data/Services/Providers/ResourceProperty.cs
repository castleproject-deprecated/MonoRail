...
namespace System.Data.Services.Providers
{
...
#endif
	{
		...
		{
			get { return this.canReflectOnInstanceTypeProperty; }
...
//		}
		...
		public Type Type
		{
			get
			{
				...
				return typeof (IEnumerable<>).MakeGenericType(new Type[1]
				                                              	{
		...
		public bool IsOfKind(ResourcePropertyKind checkKind)
		{
		...
		public static bool IsOfKind(ResourcePropertyKind propertyKind, ResourcePropertyKind kind)
		{
		...
		private static void ValidatePropertyParameters(ResourcePropertyKind kind, ResourceType propertyResourceType)
		{
			...
			if (IsOfKind(kind, ResourcePropertyKind.ResourceReference) ||
			    IsOfKind(kind, ResourcePropertyKind.ResourceSetReference))
			{
				if (propertyResourceType.ResourceTypeKind != ResourceTypeKind.EntityType)
				{
					throw new ArgumentException(Strings.ResourceProperty_PropertyKindAndResourceTypeKindMismatch("kind",
