...
namespace System.Data.Services.Providers
{
    ...
    public static class PrimitiveTypeUtils
    {
        ...
        public static readonly ResourceType StringResourceType;

        /// <summary>bool resource type.</summary>
        public static readonly ResourceType BoolResourceType;

        /// <summary>bool? resource type.</summary>
        public static readonly ResourceType NullableBoolResourceType;

        /// <summary>int resource type.</summary>
        public static readonly ResourceType ByteResourceType;

        /// <summary>int? resource type.</summary>
        public static readonly ResourceType NullableByteResourceType;

        /// <summary>int resource type.</summary>
        public static readonly ResourceType Int16ResourceType;

        /// <summary>int? resource type.</summary>
        public static readonly ResourceType NullableInt16ResourceType;

        /// <summary>int resource type.</summary>
        public static readonly ResourceType Int32ResourceType;

        /// <summary>int? resource type.</summary>
        public static readonly ResourceType NullableInt32ResourceType;

        /// <summary>long resource type.</summary>
        public static readonly ResourceType Int64ResourceType;

        /// <summary>long? resource type.</summary>
        public static readonly ResourceType NullableInt64ResourceType;

        /// <summary>long resource type.</summary>
        public static readonly ResourceType SByteResourceType;

        /// <summary>long? resource type.</summary>
        public static readonly ResourceType NullableSByteResourceType;

        /// <summary>float resource type.</summary>
        public static readonly ResourceType FloatResourceType;

        /// <summary>float? resource type.</summary>
        public static readonly ResourceType NullableFloatResourceType;

        /// <summary>double resource type.</summary>
        public static readonly ResourceType DoubleResourceType;

        /// <summary>double? resource type.</summary>
        public static readonly ResourceType NullableDoubleResourceType;

        /// <summary>decimal resource type.</summary>
        public static readonly ResourceType DecimalResourceType;

        /// <summary>decimal? resource type.</summary>
        public static readonly ResourceType NullableDecimalResourceType;

        /// <summary>Guid resource type.</summary>
        public static readonly ResourceType GuidResourceType;

        /// <summary>Guid? resource type.</summary>
        public static readonly ResourceType NullableGuidResourceType;

        /// <summary>DateTime resource type.</summary>
        public static readonly ResourceType DateTimeResourceType;

        /// <summary>DateTime? resource type.</summary>
        public static readonly ResourceType NullableDateTimeResourceType;

        /// <summary>String resource type.</summary>
        public static readonly ResourceType BinaryResourceType;

        /// <summary>String resource type.</summary>
        public static readonly ResourceType StreamResourceType;
        ...
        public static ResourceType[] PrimitiveTypes
        {
            get
            {
