...
{
	// If you have more than one AppFabric WCF Data Service in your project
	// you only need one of these EventProviders - they are all the same
	public class AppFabricDataService1EventProvider
	{
		...
		public AppFabricDataService1EventProvider()
		{
			Guid providerId;
